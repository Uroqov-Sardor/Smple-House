...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
      <form action="{{route('home.card.edit.post')}}" method="POST" enctype="multipart/form-data">
        @csrf
        @if(Session::has('msg'))
        ...
        <div class="form-floating mb-3">
          <img src="{{asset('temp/img/'.$homeCard->cardImg)}}" alt="Image" width="400px" height="200px" class="img-fluid tm-gallery-img" />
        </div>
        <div class="form-floating mb-3">
            <input value="{{$homeCard->cardTitle}}" name="cardTitle" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$homeCard->cardTitle_en}}" name="cardTitle_en" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$homeCard->cardTitle_ru}}" name="cardTitle_ru" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$homeCard->cardTitle_uz}}" name="cardTitle_uz" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
          <p>Card Text</p>
            <textarea name="cardText" class="form-control mb-3" placeholder="Card Image"
                id="floatingTextarea" style="height: 150px;">{{$homeCard->cardText}}</textarea>
            @error('cardText')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Card Text EN</p>
            <textarea name="cardText_en" class="form-control mb-3" placeholder="Card Image"
                id="floatingTextarea" style="height: 150px;">{{$homeCard->cardText_en}}</textarea>
            @error('cardText_en')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Card Text RU</p>
            <textarea name="cardText_ru" class="form-control mb-3" placeholder="Card Image"
                id="floatingTextarea" style="height: 150px;">{{$homeCard->cardText_ru}}</textarea>
            @error('cardText_ru')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Card Text UZ</p>
            <textarea name="cardText_uz" class="form-control mb-3" placeholder="Card Image"
                id="floatingTextarea" style="height: 150px;">{{$homeCard->cardText_uz}}</textarea>
            @error('cardText_uz')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
            <input value="{{$homeCard->cardPrice}}" name="cardPrice" type="text" class="form-control mb-3" id="floatingPrice"
                placeholder="Price">
        ...
        <input value="{{$homeCard->id}}" type="hidden" name="homeCardID">

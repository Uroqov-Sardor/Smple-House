...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardNoodles as $cardNoodle)
                <tr>
                    <th scope="row">{{$cardNoodle->id}}</th>
                    <td>{{$cardNoodle->cardImg}}</td>
                    <td>{{$cardNoodle->cardTitle}}</td>
                    <td>{!!$cardNoodle->cardText!!}</td>
                    <td>{{$cardNoodle->cardPrice}}</td>
                    <td>
                      <a href="{{route('home.card.noodle.editpage',['id'=>$cardNoodle->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('home.card.noodle.deletepost',['id'=>$cardNoodle->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
              @endforeach
            </tbody>
        ...
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardNoodles as $cardNoodle)
                <tr>
                    <th scope="row">{{$cardNoodle->id}}</th>
                    <td>{{$cardNoodle->cardTitle_en}}</td>
                    <td>{{$cardNoodle->cardTitle_ru}}</td>
                    <td>{{$cardNoodle->cardTitle_uz}}</td>
                    <td>
                      <a href="{{route('home.card.noodle.editpage',['id'=>$cardNoodle->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">All Post Text</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($cardNoodles as $cardNoodle)
                <tr>
                    <th scope="row">{{$cardNoodle->id}}</th>
                    <td>{!!$cardNoodle->cardText_en!!}</td>
                    <td>{!!$cardNoodle->cardText_ru!!}</td>
                    <td>{!!$cardNoodle->cardText_uz!!}</td>
                    <td>
                      <a href="{{route('home.card.noodle.editpage',['id'=>$cardNoodle->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

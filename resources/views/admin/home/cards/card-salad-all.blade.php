        ...
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardSalads as $cardSalad)
                <tr>
                    <th scope="row">{{$cardSalad->id}}</th>
                    <td>{{$cardSalad->cardImg}}</td>
                    <td>{{$cardSalad->cardTitle}}</td>
                    <td>{!!$cardSalad->cardText!!}</td>
                    <td>{{$cardSalad->cardPrice}}</td>
                    <td>
                      <a href="{{route('home.card.salad.editpage',['id'=>$cardSalad])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('home.card.salad.deletepost',['id'=>$cardSalad->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardSalads as $cardSalad)
                <tr>
                    <th scope="row">{{$cardSalad->id}}</th>
                    <td>{{$cardSalad->cardTitle_en}}</td>
                    <td>{{$cardSalad->cardTitle_ru}}</td>
                    <td>
                      <a href="{{route('home.card.salad.editpage',['id'=>$cardSalad])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardSalads as $cardSalad)
                <tr>
                    <th scope="row">{{$cardSalad->id}}</th>
                    <td>{!!$cardSalad->cardText_en!!}</td>
                    <td>{!!$cardSalad->cardText_ru!!}</td>
                    <td>
                      <a href="{{route('home.card.salad.editpage',['id'=>$cardSalad])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        @endif
        <h6 class="mb-4">Card All Post</h6>
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($homeCards as $homeCard)
                <tr>
                    <th scope="row">{{$homeCard->id}}</th>
                    <td>{{$homeCard->cardImg}}</td>
                    <td>{{$homeCard->cardTitle}}</td>
                    <td>{!!$homeCard->cardText!!}</td>
                    <td>{{$homeCard->cardPrice}}</td>
                    <td>
                      <a href="{{route('home.card.img.edit.page',['id'=>$homeCard->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('home.card.img.delete',['id'=>$homeCard->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <h6 class="mb-4">Card All Post Title</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($homeCards as $homeCard)
                <tr>
                    <th scope="row">{{$homeCard->id}}</th>
                    <td>{{$homeCard->cardTitle_en}}</td>
                    <td>{{$homeCard->cardTitle_ru}}</td>
                    <td>{{$homeCard->cardTitle_uz}}</td>
                    <td>
                      <a href="{{route('home.card.img.edit.page',['id'=>$homeCard->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">Card All Post Text</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($homeCards as $homeCard)
                <tr>
                    <th scope="row">{{$homeCard->id}}</th>
                    <td>{!!$homeCard->cardText_en!!}</td>
                    <td>{!!$homeCard->cardText_ru!!}</td>
                    <td>{!!$homeCard->cardText_uz!!}</td>
                    <td>
                      <a href="{{route('home.card.img.edit.page',['id'=>$homeCard->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
      <form action="{{route('contact.card.addpost')}}" method="POST">
        @csrf
        @if(Session::has('msg'))
        ...
        @endif
        <h6 class="mb-4">Contact Card Add Post</h6>
        ...
        <div class="form-floating mb-3">
            <input name="address" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="address_en" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="address_ru" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="address_uz" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="phone" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="email" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="fac" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input name="ins" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">

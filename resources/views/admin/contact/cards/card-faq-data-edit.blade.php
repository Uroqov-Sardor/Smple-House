...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
      <form action="{{route('contact.card.faq.data.editpost')}}" method="POST">
        @csrf
        @if(Session::has('msg'))
        ...
        @endif
        <h6 class="mb-4">Card FAQ Data Edit Post</h6>
        <div class="form-floating mb-3">
            <input value="{{$cardFaqData->title}}" name="title" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$cardFaqData->title_en}}" name="title_en" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$cardFaqData->title_ru}}" name="title_ru" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
            <input value="{{$cardFaqData->title_uz}}" name="title_uz" type="text" class="form-control mb-3" id="floatingTitle"
                placeholder="Title">
        ...
        <div class="form-floating mb-3">
          <p>Text</p>
            <textarea name="text" class="form-control mb-3" placeholder="text"
                id="floatingTextarea" style="height: 150px;">{{$cardFaqData->text}}</textarea>
            @error('text')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Text EN</p>
            <textarea name="text_en" class="form-control mb-3" placeholder="text"
                id="floatingTextarea" style="height: 150px;">{{$cardFaqData->text_en}}</textarea>
            @error('text_en')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Text RU</p>
            <textarea name="text_ru" class="form-control mb-3" placeholder="text"
                id="floatingTextarea" style="height: 150px;">{{$cardFaqData->text_ru}}</textarea>
            @error('text_ru')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-floating mb-3">
          <p>Text</p>
            <textarea name="text_uz" class="form-control mb-3" placeholder="text"
                id="floatingTextarea" style="height: 150px;">{{$cardFaqData->text_uz}}</textarea>
            @error('text_uz')
              <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <input value="{{$cardFaqData->id}}" type="hidden" name="contactCardFaqDataID">

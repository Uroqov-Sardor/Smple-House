...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        @endif
        <h6 class="mb-4">Card FAQ All Post</h6>
        <table class="table table-dark">
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$cardFaq->id}}</th>
                    <td>{{$cardFaq->title}}</td>
                    <td>{!!$cardFaq->text!!}</td>
                    <td>
                      <a href="{{route('contact.card.faq.editpage',['id'=>$cardFaq->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('contact.card.faq.deletepost',['id'=>$cardFaq->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
            </tbody>
        </table>
        <h6 class="mb-4">Card FAQ Title All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$cardFaq->id}}</th>
                    <td>{{$cardFaq->title_en}}</td>
                    <td>{{$cardFaq->title_ru}}</td>
                    <td>{{$cardFaq->title_uz}}</td>
                    <td>
                      <a href="{{route('contact.card.faq.editpage',['id'=>$cardFaq->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">Card FAQ Text All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
                <tr>
                    <th scope="row">{{$cardFaq->id}}</th>
                    <td>{!!$cardFaq->text_en!!}</td>
                    <td>{!!$cardFaq->text_ru!!}</td>
                    <td>{!!$cardFaq->text_uz!!}</td>
                    <td>
                      <a href="{{route('contact.card.faq.editpage',['id'=>$cardFaq->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

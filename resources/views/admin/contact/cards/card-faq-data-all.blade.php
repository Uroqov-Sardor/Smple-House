...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        @endif
        <h6 class="mb-4">Card FAQ Data All Post</h6>
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardFaqDatas as $cardFaqData)
                <tr>
                    <th scope="row">{{$cardFaqData->id}}</th>
                    <td>{{$cardFaqData->title}}</td>
                    <td>{!!$cardFaqData->text!!}</td>
                    <td>
                      <a href="{{route('contact.card.faq.data.editpage',['id'=>$cardFaqData->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('contact.card.faq.data.deletepost',['id'=>$cardFaqData->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <h6 class="mb-4">Card FAQ Data Title All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($cardFaqDatas as $cardFaqData)
                <tr>
                    <th scope="row">{{$cardFaqData->id}}</th>
                    <td>{{$cardFaqData->title_en}}</td>
                    <td>{{$cardFaqData->title_ru}}</td>
                    <td>{{$cardFaqData->title_uz}}</td>
                    <td>
                      <a href="{{route('contact.card.faq.data.editpage',['id'=>$cardFaqData->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">Card FAQ Data Text All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($cardFaqDatas as $cardFaqData)
                <tr>
                    <th scope="row">{{$cardFaqData->id}}</th>
                    <td>{!!$cardFaqData->text_en!!}</td>
                    <td>{!!$cardFaqData->text_ru!!}</td>
                    <td>{!!$cardFaqData->text_uz!!}</td>
                    <td>
                      <a href="{{route('contact.card.faq.data.editpage',['id'=>$cardFaqData->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
        ...
        @endif
        <h6 class="mb-4">Card Team All Post</h6>
        <table class="table table-dark">
            ...
            <tbody>
              @foreach($cardTeams as $cardTeam)
                <tr>
                    <th scope="row">{{$cardTeam->id}}</th>
                    <td>{{$cardTeam->cardImg}}</td>
                    <td>{{$cardTeam->cardName}}</td>
                    <td>{{$cardTeam->cardTitle}}</td>
                    <td>{!!$cardTeam->cardText!!}</td>
                    <td>{{$cardTeam->cardInstagram}}</td>
                    <td>{{$cardTeam->cardFacebook}}</td>
                    <td>
                      <a href="{{route('about.card.team.editpage',['id'=>$cardTeam->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
                      <a href="{{route('about.card.team.deletepost',['id'=>$cardTeam->id])}}" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <h6 class="mb-4">Card Team Name All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Card Name EN</th>
                    <th scope="col">Card Name RU</th>
                    <th scope="col">Card Name UZ</th>
                    <th scope="col" colspan="2" class="text-center">Action</th>
                </tr>
            </thead>
            <tbody>
              @foreach($cardTeams as $cardTeam)
                <tr>
                    <th scope="row">{{$cardTeam->id}}</th>
                    <td>{{$cardTeam->cardName_en}}</td>
                    <td>{{$cardTeam->cardName_ru}}</td>
                    <td>{{$cardTeam->cardName_uz}}</td>
                    <td>
                      <a href="{{route('about.card.team.editpage',['id'=>$cardTeam->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">Card Team TitleCT All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($cardTeams as $cardTeam)
                <tr>
                    <th scope="row">{{$cardTeam->id}}</th>
                    <td>{{$cardTeam->cardTitle_en}}</td>
                    <td>{{$cardTeam->cardTitle_ru}}</td>
                    <td>{{$cardTeam->cardTitle_uz}}</td>
                    <td>
                      <a href="{{route('about.card.team.editpage',['id'=>$cardTeam->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>
        ...
        <h6 class="mb-4">Card Team TextCT All Post</h6>
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>
              @foreach($cardTeams as $cardTeam)
                <tr>
                    <th scope="row">{{$cardTeam->id}}</th>
                    <td>{!!$cardTeam->cardText_en!!}</td>
                    <td>{!!$cardTeam->cardText_ru!!}</td>
                    <td>{!!$cardTeam->cardText_uz!!}</td>
                    <td>
                      <a href="{{route('about.card.team.editpage',['id'=>$cardTeam->id])}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    </td>
                    <td>

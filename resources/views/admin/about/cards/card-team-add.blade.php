...
<div class="container-fluid pt-4 px-4">
  <div class="row g-4">
    <div class="bg-light rounded h-100 p-4">
      <form action="{{route('about.card.team.addpost')}}" method="POST" enctype="multipart/form-data">
        @csrf
        @if(Session::has('msg'))
        ...
        @endif
        <h6 class="mb-4">Card Team Add Post</h6>
        ...
        <div class="form-floating mb-3">
            <input name="cardName" type="text" class="form-control mb-3" id="floatingName"
                placeholder="Name">
        ...
        <div class="form-floating mb-3">
            <input name="cardName_en" type="text" class="form-control mb-3" id="floatingName"
                placeholder="Name">
        ...
        <div class="form-floating mb-3">
            <input name="cardName_ru" type="text" class="form-control mb-3" id="floatingName"
                placeholder="Name">
        ...
        <div class="form-floating mb-3">
            <input name="cardName_uz" type="text" class="form-control mb-3" id="floatingName"
                placeholder="Name">
        ...
        <div class="form-floating mb-3">
          <input name="cardInstagram" type="text" class="form-control mb-3" id="floatingInstagram"
        ...
        <div class="form-floating mb-3">
          <input name="cardFacebook" type="text" class="form-control mb-3" id="floatingFacebook"
